...
public:
	...
	void PicPoints(vector<double>& data, CString Ox, CString Oy, double data_x_max, double step_x);

	void DrawPoints(vector<double>& data, CString Ox, CString Oy, double data_x_max, double step_x, bool flag); //flag = true - point, flag = false - graph
	...
	void My_Draw(vector<double>& data, CString Ox, CString Oy, double data_x_max, double step_x, bool flag); //flag = true - point, flag = false - graph
