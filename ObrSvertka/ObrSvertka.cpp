...
// ObrSvertka.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CObrSvertkaApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CObrSvertkaApp

CObrSvertkaApp::CObrSvertkaApp()
{
...
// Единственный объект CObrSvertkaApp

CObrSvertkaApp theApp;


// Инициализация CObrSvertkaApp

BOOL CObrSvertkaApp::InitInstance()
{
